...
function initModels(sequelize) {
  ...
  clubs.belongsToMany(users, {
    as: "userId_users_moderators",
    through: moderators,
    foreignKey: "clubId",
    otherKey: "userId",
  });
  clubs.belongsToMany(users, {
    as: "userId_users_userClubs",
    through: userClubs,
    foreignKey: "clubId",
    otherKey: "userId",
  });
  roles.belongsToMany(users, {
    as: "userId_users_userRoles",
    through: userRoles,
    foreignKey: "role",
    otherKey: "userId",
  });
  ...
  users.belongsToMany(clubs, {
    as: "clubId_clubs_moderators",
    through: moderators,
    foreignKey: "userId",
    otherKey: "clubId",
  });
  users.belongsToMany(clubs, {
    as: "clubId_clubs_userClubs",
    through: userClubs,
    foreignKey: "userId",
    otherKey: "clubId",
  });
  ...
  clubs.belongsTo(clubTypes, {
    as: "clubType_clubType",
    foreignKey: "clubType",
  });
