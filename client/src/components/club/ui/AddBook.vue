<template>
  <div class="w-full flex items-center">
    <Modal class="flex-shrink-0">
      <template #button="{ displayModal }">
        <button
          @click="displayModal"
          class="px-3 py-2 text-left bg-primary text-white hover:bg-secondary rounded flex items-center font-medium border border-primary hover:border-secondary"
        >
          <svg
    ...
    />
    <button
      class="rounded bg-b-tertiary flex-shrink-0 flex items-center justify-center text-sm p-2 mr-2"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
    ...
    <button
      class="rounded bg-b-tertiary flex-shrink-0 flex items-center justify-center text-sm p-2"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
